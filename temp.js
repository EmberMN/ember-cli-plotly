...
//console.log(JSON.stringify(Object.entries(configAttributes).reduce((obj, [key, value]) => ({ ...obj, [key]: value.dflt }), {}), null, 2));
function dfs(thing) {
  return Object.entries(thing).reduce(
    (obj, [key, value]) => ({
      ...obj,
      [key]:
        value && typeof value === 'object' ? value.dflt ?? dfs(value) : value,
    }),
    {}
  );
}
console.log(dfs(configAttributes));
